...
const ProjectCard = ({ project }: any) => {
  ...
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.98 }}
      className="group font-outfit relative bg-gradient-to-br from-indigo-50 via-blue-100 to-purple-50 text-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden"
    >
      {/* Header Section */}
        ...
        <div className="flex justify-between items-center">
          ...
          <span
            className={`px-3 py-1 rounded-full text-sm font-semibold ${
              statusColors[project.status as "active" | "warning" | "completed"]
            }`}
          >
            {project.status}
          </span>
