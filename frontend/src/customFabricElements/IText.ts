...
const ITEXT_PROPS = [...ADDITIONAL_FABRIC_PROPS] as const;
...
export class IText extends fabric.IText {
    ...
    constructor(text: string, options?: any) {
        ...
        super(text, { ...fabric.IText.ownDefaults, ...options });
   ...
   */
    ...
    toObject() {
        //@ts-ignore
        return super.toObject(ITEXT_PROPS)
    }
...
fabric.classRegistry.setClass(IText)